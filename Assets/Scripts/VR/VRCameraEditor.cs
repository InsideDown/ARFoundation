...
public class VRCameraEditor : MonoBehaviour
{
    [Header("True to update cameras instead of GameObject")]
    ...
    private void ApplyHeadOrientationToVRCameras()
    {
        ...
        if(!UpdateCameras)
        {
            this.gameObject.transform.localPosition = HeadPosition * this.gameObject.transform.lossyScale.y;
            this.gameObject.transform.localRotation = HeadRotation;
        }
        else
        {
            UpdateAllCameras();
